...
Clone the git repo - `git clone git://github.com/roots/roots-sass.git` - or [download it](https://github.com/roots/roots-sass/zipball/master) and then rename the directory to the name of your theme or website. [Install Grunt](http://gruntjs.com/getting-started), and then install the dependencies for Roots contained in `package.json` by running the following from the Roots theme directory:
